...
#chat_completion("Why is the sky blue?")
...
step_animation("Heaven", 1280, 1280, model="stable-diffusion-3.5", seed = random.randint(0, 99999), style="Photographic", max_steps=30)
